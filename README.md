# InstaByte (zomato clone)

**Live App Demo Link:** [Zomato Clone Live App Demo](https://zomatoclone.koushilmankali.in/)

Zomato is a online food ordering application, we made a clone (InstaByte) of it using React Js, Zomato Frontend clone using React Js.
